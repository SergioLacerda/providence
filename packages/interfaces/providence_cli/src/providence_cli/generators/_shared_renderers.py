...
def _render_claude_bootstrap_sections() -> list[str]:
    ...
    return [
        ...
        "",
        "1. DISCOVERY      Check `.providence/profile` (governance exists?)",
        ...
        "**Reference:** `.providence/source/README.md`",
        "",
        "## Optimized Context Loading from .providence/",
        "",
        "Load context in this order (minimal to complete):",
        "",
        "**Level 1 (MUST HAVE):**",
        "- `.providence/metadata.json`  Version, fingerprints, item counts",
        "- `.providence/compiled/audit/metadata-core.json`  Core governance state",
        "- `CLAUDE.md`  This file (bootstrap sequence)",
        "",
        "**Level 2 (AS NEEDED):**",
        "- `.providence/source/mandates/mandates.md`  Full mandate descriptions",
        "- `.providence/source/README.md`  Pre-cache strategy",
        "",
        "**Level 3 (IF SPECIFIC):**",
        "- `.providence/source/guidelines/guidelines.md`",
        "- `.providence/source/mandates/mandates.md`",
        "- `.providence/compiled/audit/metadata-client-template.json`",
        "",
        ...
        "",
        "**Reference:** `.providence/source/mandates/mandates.md`",
        "",
    ]
